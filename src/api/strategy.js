...
export function getManagedPositionSnapshot (params = {}) {
  return request({
    url: api.managedPositionSnapshot,
    method: 'get',
    params
  })
}
...
export function createManagedAccountStrategy (data) {
  return request({
    url: api.managedAccountStrategies,
    method: 'post',
    data
  })
}
